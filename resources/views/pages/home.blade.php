                ...
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                            <figure><img src="assets/images/products/{{$product->image}}" width="800" height="800" alt=""></figure>
                        </a>
                        <div class="group-flash">
                            <span class="flash-item sale-label">discount</span>
                        </div>
                        <div class="wrap-btn">
                    ...
                    <div class="product-info">
                        ...
                        <div class="wrap-price"><ins><p class="product-price">€{{number_format($product->price*(100-$product->discount)/100, 2)}}</p></ins> <del><p class="product-price">€{{number_format($product->price, 2)}}</p></del></div>
                    </div>
                </div>
                @endforeach
